...
def name_switch (origional_name)
  name_switched = origional_name.split('')
  name_switched
end
...
#   end 
#   puts "Thank you for using the Spy Name Generator, #{new_name}!"
# end 
...
#         char = "b"
#     elsif consonants.include?(char)
#       changed_consonant_index = consonants.index(char) +1
#       changed_consonants = consonants[changed_consonants_index]
#     else
#       char
#     end
...
#       puts interface_container.each_pair{|input,output| puts "#{output} is also known as {input]"}
#     end
#   end
# end
